...
func initGPSSerial() bool {
	...
	if isSirfIV {
		...
		p.Write(makeUBXCFG(0x06, 0x16, 8, []byte{0x01, 0x07, 0x03, 0x00, 0x00, 0x88, 0x04, 0x00})) // Use WAAS for North America
		...
		p.Write(makeUBXCFG(0x06, 0x01, 8, []byte{0xF0, 0x00, 0x00, 0x14, 0x00, 0x14, 0x00, 0x01})) // GGA enabled every 10th message
